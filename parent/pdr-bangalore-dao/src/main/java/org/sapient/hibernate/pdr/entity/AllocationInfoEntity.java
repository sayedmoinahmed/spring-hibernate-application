...
public class AllocationInfoEntity implements Serializable {
	...
	@Column(name = "domain", nullable = false, insertable = true, updatable = true)
	...
	@Column(name = "revenue_group", nullable = false, insertable = true, updatable = true)
